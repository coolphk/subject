        ...
        <div class="question-wrapper">
            <div class="slide" ref="slide" style="left:0">
                ...
                >
                    ...
                    <div class="number" v-else @click="showScore" style="margin-top:4vh">查看答案</div>
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            choice(key, index) {
                this.answer = key;
                this.isAnswer = true;
                this.$set(this.questions[index], "isRight", this.questions[index].rightAnswer == this.answer)//是否是正确答案
            },
            //点击下一页事件
            next(index) {
                if (!this.isAnswer) {
            ...
            showScore() {
                this.$store.commit("countWrong", this.questions);
